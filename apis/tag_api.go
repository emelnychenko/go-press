...
func (a *tagApiImpl) GetTag(tagId *models.TagId) (tag *models.Tag, err common.Error) {
...
func (a *tagApiImpl) CreateTag(data *models.TagCreate) (tag *models.Tag, err common.Error) {
...
func (a *tagApiImpl) UpdateTag(tagId *models.TagId, data *models.TagUpdate) (err common.Error) {
...
func (a *tagApiImpl) DeleteTag(tagId *models.TagId) (err common.Error) {
	tagService := a.tagService
	tagEntity, err := tagService.GetTag(tagId)
