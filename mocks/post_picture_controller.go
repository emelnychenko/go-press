...
func (m *MockPostPictureController) ChangePostPicture(httpContext contracts.HttpContext) (interface{}, common.Error) {
	m.ctrl.T.Helper()
...
func (m *MockPostPictureController) RemovePostPicture(httpContext contracts.HttpContext) (interface{}, common.Error) {
	m.ctrl.T.Helper()
