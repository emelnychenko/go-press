...
func (m *MockUserPictureController) ChangeUserPicture(httpContext contracts.HttpContext) (interface{}, common.Error) {
	m.ctrl.T.Helper()
...
func (m *MockUserPictureController) RemoveUserPicture(httpContext contracts.HttpContext) (interface{}, common.Error) {
	m.ctrl.T.Helper()
