...
func (m *MockFileService) ListFiles() ([]*entities.FileEntity, common.Error) {
	m.ctrl.T.Helper()
...
func (mr *MockFileServiceMockRecorder) ListFiles() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListFiles", reflect.TypeOf((*MockFileService)(nil).ListFiles))
}
