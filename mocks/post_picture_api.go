...
func (m *MockPostPictureApi) ChangePostPicture(userId *models.PostId, userPictureId *models.FileId) common.Error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChangePostPicture", userId, userPictureId)
	ret0, _ := ret[0].(common.Error)
	return ret0
}

// ChangePostPicture indicates an expected call of ChangePostPicture
func (mr *MockPostPictureApiMockRecorder) ChangePostPicture(userId, userPictureId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChangePostPicture", reflect.TypeOf((*MockPostPictureApi)(nil).ChangePostPicture), userId, userPictureId)
}

// RemovePostPicture mocks base method
func (m *MockPostPictureApi) RemovePostPicture(userId *models.PostId) common.Error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RemovePostPicture", userId)
	ret0, _ := ret[0].(common.Error)
	return ret0
}

// RemovePostPicture indicates an expected call of RemovePostPicture
func (mr *MockPostPictureApiMockRecorder) RemovePostPicture(userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemovePostPicture", reflect.TypeOf((*MockPostPictureApi)(nil).RemovePostPicture), userId)
}
