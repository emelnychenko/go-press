...
type (
	PostService interface {
		...
		CreatePost(postAuthor models.Subject, data *models.PostCreate) (postEntity *entities.PostEntity, err common.Error)
		UpdatePost(postEntity *entities.PostEntity, data *models.PostUpdate) (err common.Error)
		ChangePostAuthor(postEntity *entities.PostEntity, postAuthor models.Subject) (err common.Error)
