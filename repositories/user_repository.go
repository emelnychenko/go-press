...
func (r *userRepositoryImpl) GetUser(userId *models.UserId) (userEntity *entities.UserEntity, err errors.Error) {
...
func (r *userRepositoryImpl) LookupUser(userIdentity string) (userEntity *entities.UserEntity, err errors.Error) {
	userEntity = new(entities.UserEntity)
...
func (r *userRepositoryImpl) SaveUser(userEntity *entities.UserEntity) (err errors.Error) {
...
func (r *userRepositoryImpl) RemoveUser(userEntity *entities.UserEntity) (err errors.Error) {
